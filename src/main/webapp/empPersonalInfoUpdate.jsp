...
String sql = "UPDATE employees set last_name=?,middle_name=?,first_name=?,gender=?,joining_date=?,date_of_birth=?,nationality=?,martial_status=?,children=?,offical_email_id=? where emp_id=?";
...
//response.sendRedirect("empPersonalInfo.jsp");
}
catch(Exception e)
{
	out.println(e);
